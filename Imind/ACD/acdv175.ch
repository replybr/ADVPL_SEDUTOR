	...
	#define STR0053 "Transportadora invalida"
		...
		#define STR0002 "Aviso"
		#define STR0003 "Deseja estornar os produtos embarcados ?"
		#define STR0004 "Atencao"
		#define STR0005 "Informacoes"
		#define STR0006 "Embarque"
		#define STR0007 "Estorno"
		#define STR0008 "Ordem de separacao"
		#define STR0009 " nao encontrada."
		#define STR0010 "nao configurada para"
		#define STR0011 "possui itens nao separados"
		#define STR0012 "Nota nao gerada"
		#define STR0013 "para esta"
		#define STR0014 "Nota nao impressa"
		#define STR0015 "Etiquetas oficiais de volume"
		#define STR0016 "nao foram impressas"
		#define STR0017 "iniciada pelo operador"
		#define STR0018 ". Deseja continuar ?"
		#define STR0019 "Va para doca "
		#define STR0020 "referente a  "
		#define STR0021 "transportadora:"
		#define STR0022 "Confirme a "
		#define STR0023 "transportadora"
		#define STR0024 "Leia o codigo da"
		#define STR0025 "para embarcar"
		#define STR0026 "Informe a"
		#define STR0027 "Etiqueta invalida"
		#define STR0028 "Leia o volume"
		#define STR0029 "Leia o produto"
		#define STR0030 "a embarcar"
		#define STR0031 "Embarcar produto"
		#define STR0032 "Volume"
		#define STR0033 "Produto"
		#define STR0034 "Etiqueta de volume invalida"
		#define STR0035 "Codigo de volume nao cadastrado "
		#define STR0036 "Volume nao embarcado"
		#define STR0037 "Volume nao encontrado"
		#define STR0038 "pertence a outra"
		#define STR0039 "Confirma o estorno?"
		#define STR0040 "Volume ja lido"
		#define STR0041 "Quantidade invalida !"
		#define STR0042 "Quando se utiliza numero de serie a quantidade deve ser == 1"
		#define STR0043 "Produto nao separado"
		#define STR0044 "Produto invalido"
		#define STR0045 "Quantidade informada maior que a quantidade embarcada"
		#define STR0046 "Quantidade informada maior que disponivel para o embarque"
		#define STR0047 "Tipo"
		#define STR0048 "Etiqueta"
		#define STR0049 "Estorno do embarque"
		#define STR0050 "Pedido de Venda"
		#define STR0051 "Nota Fiscal"
		#define STR0052 "possui itens nao embalados"
		#define STR0053 "Transportadora invalida"
	#endif
#endif
